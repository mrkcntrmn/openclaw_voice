        ...
        ${
          state.tab === "chat"
            ? renderChat({
                ...
                voiceAvailabilityReason: state.voiceAvailabilityReason,
                voiceConfigLoading: state.voiceConfigLoading,
                voiceConfigProvider: state.voiceConfigProvider,
                voiceDeprecations: state.voiceDeprecations,
                voiceConnecting: state.voiceConnecting,
                voiceConnected: state.voiceConnected,
                voiceStatus: state.voiceStatus,
                voiceError: state.voiceError,
                voiceLiveUserTurn: state.voiceLiveUserTurn,
                voiceLiveAssistantTurn: state.voiceLiveAssistantTurn,
